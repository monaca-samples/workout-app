...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.38edcfaa.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
const Camera = registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web.c93679d4.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
